...
**Important:** Before upgrading, make sure to back up your PostgreSQL database. You can check how to backup in [the PostgreSQL charm documentation](https://documentation.ubuntu.com/charmed-postgresql-k8s/14/how-to/back-up-and-restore/).
